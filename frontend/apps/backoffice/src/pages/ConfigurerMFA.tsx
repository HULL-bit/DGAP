...
/**
 * Étape obligatoire pour tout compte interne avant accès au back-office (§6.3) —
      ...
      >
        <div className="flex flex-col items-center gap-3 text-center">
          ...
          <p className="font-corps text-sm text-text-muted dark:text-text-inv-muted">
            Obligatoire pour tous les comptes internes avant d'accéder au back-office (§6.3).
          </p>
        </div>
